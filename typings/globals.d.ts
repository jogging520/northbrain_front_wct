declare module 'wepy' {
    ...
    import page from "wepy/page";
    import app from "wepy/app";
    import util from "wepy/util";
    ...
    class InterfaceComponent extends component {
        getCurrentPages(): [any];
        $parent:InterfacePage|any;
        onLoad(params, data);
    }
    class InterfacePage extends page {
        getCurrentPages(): [any];
        $parent:App|any;
        onLoad(params, data);
    }
    ...
    interface DefaultExport extends baseWxEnhances {
        event: Event;
        app: App;
        component: Component;
        page: Page;
